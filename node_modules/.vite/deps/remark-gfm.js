...
function tokenizeBlankLine(effects, ok3, nok) {
  ...
  function after(code2) {
    return code2 === codes2.eof || markdownLineEnding(code2) ? ok3(code2) : nok(code2);
  }
}
...
function tokenizeLabelStartImage(effects, ok3, nok) {
  ...
  function after(code2) {
    return code2 === codes2.caret && "_hiddenFootnoteSupport" in self.parser.constructs ? nok(code2) : ok3(code2);
  }
}
...
function tokenizeIndent(effects, ok3, nok) {
  ...
  function afterPrefix(code2) {
    ...
    return tail && tail[1].type === "gfmFootnoteDefinitionIndent" && tail[2].sliceSerialize(tail[1], true).length === constants2.tabSize ? ok3(code2) : nok(code2);
  }
}
...
function spaceThenNonSpace(effects, ok3, nok) {
  ...
  function after(code2) {
    return code2 === codes5.eof ? nok(code2) : ok3(code2);
  }
}
